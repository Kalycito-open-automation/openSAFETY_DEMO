...
**    History:
*******************************************************************************
**    15.07.2009    Review EPS SI V10
**    23.08.2012    FD    (change)    deleted includefile At91sam7s.h to be compatible to At91sam3s
    23.01.2013    Review EPS SDC V01
**
********************************************************************************
**    all rights reserved
*******************************************************************************/
...
*/
#define EPLS_k_TARGET_STRING "Cortex-M4"
...
/** SET_PIN:
    Define to set the corresponding pin for the time measurement.
*/
#ifdef SET_PIN
  #undef SET_PIN
#endif
#define SET_PIN gpPIO->PIO_SODR = DBG_OUT

/** RESET_PIN:
    Define to reset the corresponding pin for the time measurement.
*/
#ifdef RESET_PIN
  #undef RESET_PIN
#endif
#define RESET_PIN  gpPIO->PIO_CODR = DBG_OUT;
