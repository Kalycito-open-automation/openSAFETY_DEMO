...
FUNCTION(ENABLE_COVERAGE_REPORT)
    ...
    IF(CMAKE_COMPILER_IS_GNUCC AND TOOL_FOUND AND "${COVERAGE_BUILD_TYPE}" MATCHES "coverage")
        ...
        IF(GCOVR_FOUND)
            ...
            FILE(APPEND ${COVERAGE_XML_COMMAND_FILE}
                 "EXECUTE_PROCESS(COMMAND \"${GCOVR_EXECUTABLE}\" -e unittest* -x -r \"${CMAKE_SOURCE_DIR}\" OUTPUT_FILE \"${COVERAGE_XML_FILE}\" WORKING_DIRECTORY \"${CMAKE_BINARY_DIR}/\")\n")
